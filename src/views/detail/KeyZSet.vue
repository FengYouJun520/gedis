...
<template>
  <div flex flex-col gap-y-4>
    ...
    >
      ...
      <el-table-column prop="score" label="Score" sortable show-tooltip-when-overflow />
      <el-table-column prop="member" label="Member" sortable show-tooltip-when-overflow />
